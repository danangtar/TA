...
spf = wave.open('testquadrde.wav', 'r')
...
with open("lmquadrde", mode='rb') as file:  # b is important -> binary
...
print(tulis[10467])
write('returnquadrde.wav', 44100, tulis)
